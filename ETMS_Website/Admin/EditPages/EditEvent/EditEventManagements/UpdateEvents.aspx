<%@ Page Title="Admin - Update Event" Language="C#" MasterPageFile="~/Admin/SiteAdmin.master" AutoEventWireup="true" CodeBehind="UpdateEvents.aspx.cs" Inherits="ETMS_Website.Admin.EditPages.EditEvent.EditEventManagements.UpdateEvents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SiteAdminContentPlaceHolder" runat="server">
    ...
    <div class="w-100 custom-footer">
        <asp:Button ID="btnUpdate" runat="server" CssClass="btn btn-primary custom-button" Text="Update" OnClick="btnUpdate_Click" ValidationGroup="groupEvents1" />
    </div>
