<%@ Page Title="Admin - Add Ticket Type" Language="C#" MasterPageFile="~/Admin/SiteAdmin.master" AutoEventWireup="true" CodeBehind="AddTicketTypes.aspx.cs" Inherits="ETMS_Website.Admin.EditPages.EditTicketTypes.AddTicketTypes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SiteAdminContentPlaceHolder" runat="server">
        ...
        <div class="w-100 h-auto d-flex flex-column">
            ...
            <div class="row container-fluid">
                ...
                <div class="col-6 d-flex flex-column align-items-center">
                    <asp:Label runat="server" AssociatedControlID="dtStartSell" Text="Select Start Sell" />
                ...
                <div class="col-6 d-flex flex-column align-items-center">
                    <asp:Label runat="server" AssociatedControlID="dtEndSell" Text="Select End Sell" />
    ...
    <div class="w-100 custom-footer">
        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary custom-button" Text="Add" OnClick="btnAdd_Click" ValidationGroup="groupTicketTypes1" />
    </div>
    <asp:CustomValidator runat="server" ID="cvCheckTicketType" ForeColor="Red" OnServerValidate="cvCheckTicketType_ServerValidate" Display="Dynamic" ValidationGroup="groupTicketTypes1"></asp:CustomValidator>
</asp:Content>
