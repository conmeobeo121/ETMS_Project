<%@ Page Title="Admin - Updated Venue" Language="C#" MasterPageFile="~/Admin/SiteAdmin.master" AutoEventWireup="true" CodeBehind="UpdateVenues.aspx.cs" Inherits="ETMS_Website.Admin.EditPages.EditVenues.UpdateVenues" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SiteAdminContentPlaceHolder" runat="server">
    <div class="container-fluid d-flex flex-column">
        ...
        <div class="w-100 h-auto d-flex flex-column">
            <div>
                <asp:HiddenField runat="server" ID="hdnIDVenue" />
    ...
    <div class="w-100 custom-footer">
        <asp:Button ID="btnUpdate" runat="server" CssClass="btn btn-primary custom-button" Text="Update" OnClick="btnUpdate_Click" ValidationGroup="groupVenues1" />
    </div>
</asp:Content>
